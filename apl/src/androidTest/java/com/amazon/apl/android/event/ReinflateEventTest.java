...
import static com.amazon.apl.android.document.AbstractDocViewTest.BASE_DOC_REINFLATE_SEND_EVENT_ARGUMENT;
...
public class ReinflateEventTest extends AbstractDocUnitTest {
    ...
    public void testReinflate_rootContextReinflate_invoked() throws JSONException {
        ...
        String[] arguments = new String[]{BASE_DOC_REINFLATE_SEND_EVENT_ARGUMENT};
