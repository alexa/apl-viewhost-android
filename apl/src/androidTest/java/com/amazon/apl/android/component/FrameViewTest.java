...
public class FrameViewTest extends AbstractComponentViewTest<APLAbsoluteLayout, Frame> {
    ...
    public void testView_dynamicBackgroundColor() {
        ...
        for (String expectedColor : COLORS.keySet()) {
            onView(isRoot())
                    .perform(executeCommands(mTestContext.getRootContext(), setValueCommand("backgroundColor", expectedColor)));
    ...
    public void testView_dynamicBorderColor() {
        ...
        for (String expectedColor : COLORS.keySet()) {
            onView(isRoot())
                    .perform(executeCommands(mTestContext.getRootContext(), setValueCommand("borderColor", expectedColor)));
