...
public class ExtensionMediatorTest extends APLViewhostTest {
    // Test content
    ...
    @Mock
    private RemoteExtensionProxy mRemoteExtensionProxy;
    @Mock
    ...
    public void setup() {
        ...
        Collection<ExtensionProxy> remoteExtensionProxies = Arrays.asList(mRemoteExtensionProxy);
