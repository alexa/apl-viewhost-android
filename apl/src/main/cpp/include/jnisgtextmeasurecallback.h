...
#ifndef ANDROID_JNISGTEXTMEASURECALLBACK_H
#define ANDROID_JNISGTEXTMEASURECALLBACK_H
...
*/
jboolean
sgtextmeasurecallback_OnLoad(JavaVM *vm, void * reserved ) ;

/**
* Release the class and method cache.
*/
void
sgtextmeasurecallback_OnUnload(JavaVM *vm, void * reserved ) ;
...
#endif //ANDROID_JNISGTEXTMEASURECALLBACK_H
