...
public class LoadDocumentTest extends AbstractDocViewTest {
    ...
    public void testRestoreDocument_docLoadingWithHighMemory() {
        inflate(DOC_STRING_FUNCTIONS, "");
        mAPLController.finishDocument();
        assertTrue(mAPLController.isFinished());

        inflate(DOC_MEM_PRESSURE, "", PAYLOAD_MEM_PRESSURE, DATA_MEM_PRESSURE, APLOptions.builder());
