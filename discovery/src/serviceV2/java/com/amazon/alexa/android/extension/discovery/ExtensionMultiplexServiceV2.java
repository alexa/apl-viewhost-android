...
import com.amazon.alexa.android.extension.discovery.ConnectionMonitorList;
import com.amazon.alexa.android.extension.discovery.L2_IRemoteClient;
import com.amazon.alexa.android.extension.discovery.L2_IRemoteServiceV2;
...
public final class ExtensionMultiplexServiceV2 {
    ...
    interface IMultiplexServiceConnection extends IBinder {
    ...
    static class ServiceConnection extends L2_IRemoteServiceV2.Stub implements IMultiplexServiceConnection {
        ...
        @SuppressWarnings("RedundantThrows")
        @Override
        public synchronized void L2_connect(final L2_IRemoteClient client, final String configuration)
                throws RemoteException {
            ...
            try {
                final ConnectionID connectionID = ConnectionID.valueOf(getCallingPid(), client.L2_connectionID());
        ...
        public synchronized void L2_receive(final int clientID, final int routingID, final ActivityDescriptor activity, final String message) throws RemoteException {
            ...
            final ConnectionID connectionID = ConnectionID.valueOf(getCallingPid(), clientID);
        ...
        @Override
        public synchronized void L2_onResourceAvailable(final int clientID, final int routingID, final ActivityDescriptor activity, final Surface surface, final Rect rect, final String resourceID) throws RemoteException {
        ...
        private void notifyResourceAvailable(final ConnectionID connectionID, final int routingID, final ActivityDescriptor activity, final Surface surface, final Rect rect, final String resourceID) throws IllegalStateException {
        ...
        @Override
        public synchronized void L2_onResourceUnavailable(final int clientID, final int routingID, final ActivityDescriptor activity, final String resourceID) throws RemoteException {
        ...
        @Override
        public void L2_onRegistered(final int clientID, final int routingID, final ActivityDescriptor activity) throws RemoteException {
        ...
        @Override
        public void L2_onUnregistered(final int clientID, final int routingID, final ActivityDescriptor activity) throws RemoteException {
        ...
        @Override
        public void L2_onSessionStarted(final int clientID, final int routingID, final SessionDescriptor session) throws RemoteException {
        ...
        @Override
        public void L2_onSessionEnded(final int clientID, final int routingID, final SessionDescriptor session) throws RemoteException {
        ...
        @Override
        public void L2_onForeground(final int clientID, final int routingID, final ActivityDescriptor activity) throws RemoteException {
        ...
        @Override
        public void L2_onBackground(final int clientID, final int routingID, final ActivityDescriptor activity) throws RemoteException {
        ...
        @Override
        public void L2_onHidden(final int clientID, final int routingID, final ActivityDescriptor activity) throws RemoteException {
